...
（20191119 追記）
本記事の補足記事[【第4回補足】](https://qiita.com/snishym/items/f343f24ca8c77ba1fb4a)を書きました。反応時間の他の取得方法について説明しています。本チュートリアルのメインテーマであるサイモン課題の作成にはあまり関係ありませんが，実際にご自身の実験を作成するときに参考になるかもしれません。
